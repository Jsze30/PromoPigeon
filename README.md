...
You must use Python for this application. Please include a requirements.txt for any libraries you use. Both Flask and FastAPI are acceptable as web app frameworks. 
...
We will review the code you submit for code quality and correctness, though it is not expected that your solution is fully production ready. 
